          ...
          <div className="max-w-4xl mx-auto">
            <div className="premium-card p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white font-display">{t('home.evidence_title')}</h2>
              ...
              <div className="grid sm:grid-cols-4 gap-4 text-center">
                {[
                  ...
                  { label: _('Origine CAD', 'CAD origin'), value: _('4 origini addestrate', '4 trained origins') },
                  ...
                  <div key={item.label} className="py-3 px-2 rounded-lg bg-white/5">
